...
const PROBLEMS = [
  ...
  {
    icon: "😵",
    text: "Tenta analisar... sem entender o que está olhando",
  },
];
    ...
    <section className="relative px-4 py-20 sm:py-28">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-3">
          {PROBLEMS.map((p, i) => (
            ...
            >
              ...
              <p className="mt-4 text-base text-muted-foreground">{p.text}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <span className="text-gradient-gold font-bold">É não ter um processo.</span>
        </motion.p>
      </div>
    </section>
  );
